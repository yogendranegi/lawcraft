        ...
        <div class="blog-post">
            <div class="blog-image-wrapper">
                ...
                <div id="author-section" class="meta">
                    ...
                    <span class="meta-item author"><?php echo $postedby ?><i class="fa fa-user"></i><a class="author-post-url" href="<?php echo esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ) ?>"><?php the_author() ?></a>
                    </span>
